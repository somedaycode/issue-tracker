...
protocol AssigneeNetworkManagerPort {
    func getAssigneeList(completionHandler: @escaping (Data?) -> Void)
}

class AssigneeNetworkManager: AssigneeNetworkManagerPort {
    func getAssigneeList(completionHandler: @escaping (Data?) -> Void) {
        let url = AssigneeEndpoint.getAssigneeList().url
